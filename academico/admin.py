...
from .models import PreRequisito, DisciplinaCurso, Periodo, MatriculaDisciplina
# Register your models here.


class AlunoAdmin (admin.ModelAdmin):
    list_display = ['cpf', 'nome', 'dataNascimento', 'sexo', 'cep', 'complemento']
...
class ProfessorAdmin (admin.ModelAdmin):
    list_display = ['cfe', 'nome', 'dataNascimento', 'sexo', 'cep', 'complemento']
    search_display = ['sexo', 'created', 'modified']
    list_filter = ['sexo']
...
class CursoAdmin (admin.ModelAdmin):
    list_display = ['nome', 'creditos', 'cargaHoraria', 'cargaHorariaObrigatoria', 'departamento']
...
class MatriculaAdmin (admin.ModelAdmin):
	list_display = ['matricula', 'cpf', 'curso', 'tipoMatricula', 'dataAdmissao']
	search_display = ['matricula', 'curso', 'tipoMatricula']
	list_filter = ['matricula', 'curso', 'tipoMatricula']

admin.site.register(Matricula, MatriculaAdmin)

class DisciplinaAdmin (admin.ModelAdmin):
	list_display = ['nome', 'cargaHoraria', 'creditos', 'departamento']
	search_display = ['departamento', 'nome']
	list_filter = ['departamento', 'nome']
...
admin.site.register(MatriculaDisciplina, MatriculaDisciplinaAdmin)